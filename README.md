...
| `show_toolbar` | `bool` | `True` | Whether to render the interactive toolbar. Set to `False` to hide the Rows, Columns, Values, Filters, and toolbar controls while keeping the pivot table visible. |
